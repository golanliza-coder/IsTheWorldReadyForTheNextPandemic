...
The project assesses the preparedness of countries worldwide for the next global pandemic using a combination of global health variables 
and compares this assessment against a recognized, measurable global benchmark (such as that of the WHO or the Global Health Security Initiative—GHSI).
